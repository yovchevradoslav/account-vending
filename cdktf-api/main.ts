...
import { App, TerraformStack, TerraformAsset, AssetType, TerraformOutput, S3Backend } from "cdktf";
import * as aws from "@cdktf/provider-aws";
import * as random from "@cdktf/provider-random";

const REGION = 'eu-west-1'
const PROFILE = 'projectx'
const STATE_BUCKET = 'projectx-terraform-state-bucket'
